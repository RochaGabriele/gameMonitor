      ...
      <div class='container'>
        ...
        <div class='collapse navbar-collapse' id='items'>
          <ul class='navbar-nav mr-auto'>
            <li class='nav-item'><a class='nav-link text-secondary' href="homeAuxiliar.jsp">Home</a></li>
            <li class='nav-item'><a class='nav-link text-secondary' href="cadInfor.jsp">Gerenciamento de Partidas</a></li>
			<li class='nav-item'><a class='nav-link text-secondary' href="ServAtor?metodo=selecionarPerfil&&destino=perfilAuxiliar.jsp&&id=<%= idMenu %>">Perfil</a></li>
          </ul>
      	</div>
      </div>
     </nav>
