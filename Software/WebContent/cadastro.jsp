			...
			<form action="ServAtor" method="post" class="form container">
				...
				<div class="campos">
					...
					<div class="form-group">
				    	...
				    	<input type="text" class="form-control" name="user" id="user"  placeholder="Seu nome de usu�rio" required/>
				  	</div>
				  	<div class="form-group ">
				    ...
				    <div class="form-group">
				    	...
				    	<input type="text" class="form-control" name="tel" id="tel"  placeholder="DDD e n�mero sem caracteres especiais como '('  ')'  '.'  '-' " required/>
				  	</div>
				  	<div class="form-group">
	  			...
	  			<div class="link-login medium mt-1 ">
			    	<a class="font link" href="index.jsp">J� � cadastrado? Fa�a login!</a>
				</div>
				</div>
			</form>
