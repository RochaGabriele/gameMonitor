      ...
      <div class='container'>
        ...
        <div class='collapse navbar-collapse' id='items'>
          <ul class='navbar-nav mr-auto'>
            <li class='nav-item'><a class='nav-link text-secondary' href="homeTecnico.jsp">Home</a></li>
            <li class='nav-item'><a class='nav-link text-secondary' href="ServPf?cargo=Tecnico">Resumo de partidas</a></li>
			<li class='nav-item'><a class='nav-link text-secondary' href="ServAtor?metodo=selecionarPerfil&&destino=perfilTecnico.jsp&&id=<%= idMenu %>">Perfil</a></li>
          </ul>
      	</div>
      </div>
     </nav>
