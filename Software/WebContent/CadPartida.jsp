	...
	<% 
		...
		<span class="small d-block text-center">Cadastro das partidas</span>
				...
				<input type="hidden" readonly="readonly" name="metodo"  value="inserirPartida" />
					    ...
					    <div class="input-group mt-2">
					        <input type="time" class="form-control bg-light btn-outline-transparent"  name="horario"  placeholder="Hor�rio" required>
					    </div>
					    <div class="input-group mt-2">
					   ...
					   <div class="input-group mt-2">
					    ...
					    <div class="input-group mt-2">
					        <input type="text" class="form-control bg-light btn-outline-transparent"  name="nomeAdversario"  placeholder="Nome do time advers�rio" required>
					    </div>
					    <div class="input-group mt-2">
					        <input type="text" class="form-control bg-light btn-outline-transparent"  name="nomeArbitro"  placeholder="Nome do �rbitro" required>
					    </div>
					    <div class="input-group mt-2">
