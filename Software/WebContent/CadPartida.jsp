	...
	<%@ include file="menuApoio.jsp"%>
		...
		<span class="small d-block text-center">Cadastro das partidas</span>
				...
				<form method="post"  action="serv"  class="form">
					    ...
					    <div class="input-group mt-2">
					        <input type="time" class="form-control bg-light btn-outline-transparent"  name="horario"  placeholder="Horário">
					    </div>
					    <div class="input-group mt-2">
					   ...
					   <div class="input-group mt-2">
					    ...
					    <div class="input-group mt-2">
					        <input type="text" class="form-control bg-light btn-outline-transparent"  name="nomeAdversario"  placeholder="Nome do time adversário">
					    </div>
					    <div class="input-group mt-2">
					        <input type="text" class="form-control bg-light btn-outline-transparent"  name="nomeArbitro"  placeholder="Nome do árbitro">
					    </div>
					    <div class="input-group mt-2">
